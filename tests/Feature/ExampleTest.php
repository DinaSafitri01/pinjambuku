...
//migra add jatuh tempo and ringkasan to peminjaman//
<?php
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('peminjaman', function (Blueprint $table) {
            $table->date('tanggal_jatuh_tempo')->after('tanggal_pinjam')->nullable();
            $table->text('ringkasan')->after('status')->nullable();
        });
    }
    ...
    {
        Schema::table('peminjaman', function (Blueprint $table) {
            $table->dropColumn(['tanggal_jatuh_tempo', 'ringkasan']);
        });
    }
};
